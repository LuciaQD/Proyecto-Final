...
Proseguiremos con un analisis geografico de los siniestros y notaremos las diferencias que surgen de los distintos departamentos con respecto a la cantidad de siniestros incluyendo a su vez otras de las variables categoricas que tenemos disponibles.

Comencemos primero observando unicamente la cantidad de accidentes segun departamento:
```{r}
datos %>%
  ...
  ggtitle("Cantidad de siniestros por departamento")

cap11<-("Montevideo tiene una cantidad de accidentes mayor, como era lo esperado, seguido de Canelones y Maldonado")
```

Luego miraremos como 
