...
Comenzamos con un análisis temporal intentando ver las variaciones en los años, meses, dias de la semana y hora de los siniestros
...
cap1 <- "A partir del gráfico podemos observar que del año 2013 al 2015 hubo un incremento sostenido en la cantidad de siniestros habiendo un decenso en el año 2016 para volver a crecer en el 2017. De todas formas no se observa una variación importante a lo largo del periodo."

```

grafico por mes por año
grafico por dia de la semana por año
grafico por hora por año 
...
-Cambiar selectinput para aÃ±o y variable(el filtro de aÃ±o va afuera del if)
